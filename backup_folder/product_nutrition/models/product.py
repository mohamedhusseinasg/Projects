...
class ProductTemplate(models.Model):
    ...
    energy_joule_uom = fields.Float(string="Energy per UoM (kJ)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    energy_calories_uom = fields.Float(string="Energy per UoM (kcal)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    fat_total_uom = fields.Float(string="Fat total per UoM (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    fat_saturated_uom = fields.Float(string="Fat saturated per UoM (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    carbohydrate_uom = fields.Float(string="Carbohydrate per UoM (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    carbo_sugars_uom = fields.Float(string="Sugars per UoM (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    roughage_uom = fields.Float(string="Roughage per UoM (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    protein_uom = fields.Float(string="Protein per UoM (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    sodium_uom = fields.Float(string="Sodium per UoM (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    ...
    energy_joule_portion = fields.Float(string="Energy per portion (kJ)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    energy_calories_portion = fields.Float(string="Energy per portion (kcal)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    fat_total_portion = fields.Float(string="Fat total per portion (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    fat_saturated_portion = fields.Float(string="Fat saturated per portion (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    carbohydrate_portion = fields.Float(string="Carbohydrate per portion (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    carbo_sugars_portion = fields.Float(string="Sugars per portion (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    roughage_portion = fields.Float(string="Roughage per portion (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    protein_portion = fields.Float(string="Protein per portion (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    sodium_portion = fields.Float(string="Sodium per portion (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
...
class ProductProduct(models.Model):
    ...
    energy_joule_uom = fields.Float(string="Energy per UoM (kJ)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    energy_calories_uom = fields.Float(string="Energy per UoM (kcal)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    bread_units_uom = fields.Float(string="Bread Units per UoM (BU)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, readonly=True, store=True)
    fat_total_uom = fields.Float(string="Fat total per UoM (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    fat_saturated_uom = fields.Float(string="Fat saturated per UoM (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    carbohydrate_uom = fields.Float(string="Carbohydrate per UoM (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    carbo_sugars_uom = fields.Float(string="Sugars per UoM (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    ...
    energy_joule_portion = fields.Float(string="Energy per portion (kJ)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    energy_calories_portion = fields.Float(string="Energy per portion (kcal)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    bread_units_portion = fields.Float(string="Bread Units per portion (BU)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, readonly=True, store=True)
    fat_total_portion = fields.Float(string="Fat total per portion (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    fat_saturated_portion = fields.Float(string="Fat saturated per portion (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    carbohydrate_portion = fields.Float(string="Carbohydrate per portion (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
    carbo_sugars_portion = fields.Float(string="Sugars per portion (g)", compute='_compute_facts_uom', digits=dp.get_precision('Stock Weight'), default=0, store=True)
